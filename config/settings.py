...
UI_PATH = '/home/asj53/BOScheduling/UI/pages/plots/'
INDEX_WEIGHTS = {
    0: 5,   
}
"""
...
SEQ_BOUNDS = {
    ...
    'large_cutoff_freedom' : [0,4]  }  # large_size_2}}
...
#},
PARAM_NAMES = (
        list(BLOCK_BOUNDS.keys())
        + list(SEQ_BOUNDS  .keys())
        + list(PP_BOUNDS   .keys())
    )
LICENSES = [
    {
...
def get_name(param_dict, optim_mode=OPTIM_MODE, global_ts=None,
